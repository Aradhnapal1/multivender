            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center py-2">
                    ...
                    <ol class="breadcrumb d-lg-flex d-none mb-0">
                        ...
                        <li class="breadcrumb-item"><a href=""> Add Size </a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" id="addSizeForm">

                            <!-- Size Name -->
                            <div class="mb-3">
                                <label class="form-label" for="sizeName">Size Name</label>
...
.form-check-input:focus {
    box-shadow: none;
            ...
            <div class="d-flex justify-content-end mb-3">
                ...
                <button type="button" class="btn btn-dark" id="addEditBtn">
                    Update Size
                </button>
            </div>
