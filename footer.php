    ...
    <div class="custom-container">
                    ...
                    <ul class="footer-content-list">
                        <li>
                            <a href="tel:(603)555-0123" class="content-box">
                                <svg>
                                    <use
                                        xlink:href="https://themes.pixelstrap.net/kartify/assets/svg/footer-icon.svg#contact">
                                    </use>
                                </svg>
                                <h4>+91 8586084450</h4>
                            </a>
                        ...
                        <li>
                            <a href="#!" class="content-box">
                                <div class="footer-content-icon">
                                    <svg>
                                        <use
                                            xlink:href="https://themes.pixelstrap.net/kartify/assets/svg/footer-icon.svg#location">
                                        </use>
                                    </svg>
                                </div>
                                <h5>Unit -314, Tower A, ATS Bouquet, sector -132, Noida , Uttar Pradesh</h5>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:pixelstrap@contact.com" class="content-box">
                                <div class="footer-content-icon">
                                    <svg>
                                        <use
                                            xlink:href="https://themes.pixelstrap.net/kartify/assets/svg/footer-icon.svg#mail">
                                        </use>
                                    </svg>
                                </div>
                    ...
                    <ul class="app-store-link">
                        <li>
                            <a href="https://play.google.com/store/apps" target="_blank">
                                <img src="https://themes.pixelstrap.net/kartify/assets/images/google-play.svg"
                                    class="img-fluid" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="https://www.apple.com/in/app-store/" target="_blank">
                                <img src="https://themes.pixelstrap.net/kartify/assets/images/app-store.svg"
                                    class="img-fluid" alt="">
                            </a>
                        </li>
                    </ul>
        ...
        <div class="sub-footer">
            ...
            <ul class="payment-list">
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/1.svg" class="img-fluid"
                        alt="">
                </li>
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/2.svg" class="img-fluid"
                        alt="">
                </li>
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/3.svg" class="img-fluid"
                        alt="">
                </li>
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/4.svg" class="img-fluid"
                        alt="">
                </li>
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/5.svg" class="img-fluid"
                        alt="">
                </li>
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/6.svg" class="img-fluid"
                        alt="">
                </li>
                <li>
                    <img src="https://themes.pixelstrap.net/kartify/assets/images/payment/7.svg" class="img-fluid"
                        alt="">
                </li>
            </ul>
        </div>
...
<!-- Footer Section End -->
  ...
  <div class="offcanvas offcanvas-end cart-offcanvas" id="cartOffcanvas">
      ...
      <div class="offcanvas-body">
          <div class="cart-product-box">
              ...
              <div class="total-price-box" id="offcanvasCartFooterActions">
  ...
  <!-- Share product (used by product-detail.php and other product templates) -->
  <div class="modal theme-modal product-share-modal fade" id="shareProductModal" tabindex="-1" aria-labelledby="shareProductModalTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-header justify-content-between">
                  <h3 class="modal-title" id="shareProductModalTitle">Share this product</h3>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                      <i class="ri-close-line"></i>
                  </button>
              </div>
              <div class="modal-body">
                  <p class="small text-muted mb-2">Anyone with this link can open the product page.</p>
                  <div class="theme-form input-group mb-3">
                      <input type="text" class="form-control" id="shareProductPageUrl" readonly value="">
                      <button type="button" class="btn btn-bg-theme" id="shareProductCopyBtn">Copy</button>
                  </div>
                  <p class="small text-muted mb-2">Share on</p>
                  <div class="d-flex flex-wrap gap-2 justify-content-center">
                      <a href="#!" class="btn btn-outline-primary btn-sm" data-share-network="facebook" aria-label="Facebook"><i class="ri-facebook-fill"></i></a>
                      <a href="#!" class="btn btn-outline-dark btn-sm" data-share-network="twitter" aria-label="X"><i class="ri-twitter-x-line"></i></a>
                      <a href="#!" class="btn btn-outline-danger btn-sm" data-share-network="pinterest" aria-label="Pinterest"><i class="ri-pinterest-fill"></i></a>
                      <a href="#!" class="btn btn-outline-success btn-sm" data-share-network="whatsapp" aria-label="WhatsApp"><i class="ri-whatsapp-fill"></i></a>
                      <a href="#!" class="btn btn-outline-secondary btn-sm" data-share-network="instagram" aria-label="Copy for Instagram"><i class="ri-instagram-fill"></i></a>
                  </div>
              </div>
          </div>
      </div>
